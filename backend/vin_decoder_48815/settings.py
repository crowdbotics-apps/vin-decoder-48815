"""
Django settings for vin_decoder_48815 project.
...
ROOT_URLCONF = 'vin_decoder_48815.urls'
...
WSGI_APPLICATION = 'vin_decoder_48815.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Vin Decoder Support <support@vin-decoder-48815.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vin_decoder_48815 API",
    "DESCRIPTION": "API documentation for vin_decoder_48815 App",
    "VERSION": "v1",
}
